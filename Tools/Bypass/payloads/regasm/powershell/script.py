...
regasm C# unmanaged powershell embedded script execution.
...
class PayloadModule:
    ...
    def __init__(self, cli_obj):
        # required
        self.language = "regasm_powershell"
        self.extension = "cs"
        self.rating = "Excellent"
        self.description = "regasm C# unmanaged powershell embedded script execution"
        self.name = "regasm C# Unmanaged powershell embedded script execution"
        self.path = "regasm/powershell/script"
