...
Custom-written pure regasm meterpreter/reverse_http stager.
...
class PayloadModule:
    ...
    def __init__(self, cli_obj):
        ...
        self.description = "pure regasm windows/meterpreter/reverse_http stager"
        self.name = "Pure Regasm C# Reverse HTTP Stager"
        self.path = "regasm/meterpreter/rev_http"
