...
Custom-written pure installutil meterpreter/reverse_https stager.
...
class PayloadModule:
    ...
    def __init__(self, cli_obj):
        # required options
        self.description = "pure installutil windows/meterpreter/reverse_https stager"
        self.language = "installutil"
        self.extension = "cs"
        self.rating = "Excellent"
        self.name = "Pure installutil Reverse HTTPS Stager"
        self.path = "installutil/meterpreter/rev_https"
