...
Custom-written pure installutil meterpreter/reverse_tcp stager.
...
class PayloadModule:
    ...
    def __init__(self, cli_obj):
        # required options
        self.description = "pure installutil windows/meterpreter/reverse_tcp stager"
        self.language = "installutil"
        self.extension = "cs"
        self.rating = "Excellent"
        self.name = "Pure installutil Reverse TCP Stager"
        self.path = "installutil/meterpreter/rev_tcp"
