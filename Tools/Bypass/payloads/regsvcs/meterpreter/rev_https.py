...
Custom-written pure regsvcs meterpreter/reverse_https stager.
...
class PayloadModule:
    ...
    def __init__(self, cli_obj):
        ...
        self.description = "pure regsvcs windows/meterpreter/reverse_https stager"
        self.name = "regsvcs C# Flat Shellcode Injector"
        self.path = "regsvcs/meterpreter/rev_https"
