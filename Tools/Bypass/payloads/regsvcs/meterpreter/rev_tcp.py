...
Custom-written pure regsvcs meterpreter/reverse_tcp stager.
...
class PayloadModule:
    ...
    def __init__(self, cli_obj):
        ...
        self.description = "pure regsvcs windows/meterpreter/reverse_tcp stager"
        self.name = "Pure InstallUtil C# Reverse TCP Stager"
        self.path = "regsvcs/meterpreter/rev_tcp"
