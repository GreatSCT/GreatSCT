...
Custom-written pure regsvcs meterpreter/reverse_http stager.
...
class PayloadModule:
    ...
    def __init__(self, cli_obj):
        ...
        self.description = "pure regsvcs windows/meterpreter/reverse_http stager"
        self.name = "Pure RegSvcs C# Reverse HTTP Stager"
        self.path = "regsvcs/meterpreter/rev_http"
